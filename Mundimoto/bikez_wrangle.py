...
bikez_df = pd.read_csv('landing/persistent/bikez_scrape/all_bikez_data.csv')
brands_df = pd.read_csv('landing/persistent/bikez_scrape/bikez_brands_data.csv')
mundimoto_df = pd.read_csv('landing/persistent/mundimoto/mundimoto2.csv')
...
# merge clean-up
bikez_df.drop(['Model and Year'], axis=1, inplace=True)
...
bikez_df.to_csv('landing/persistent/bikez_scrape/all_bikez_curated.csv', index=False)